 ...
 * <p>
 * To show the dialog, start with {@link #createBuilder(android.content.Context, android.app.FragmentManager)}.
 * </p>
 * <p>
...
public class ProgressDialogFragment extends BaseDialogFragment {
	...
	protected Builder build(Builder builder) {
		...
		final int messageTextColor = a.getColor(R.styleable.DialogStyle_sdlMessageTextColor, defaultMessageTextColor);
		a.recycle();
